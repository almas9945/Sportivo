...
public class Registration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editName = (EditText)findViewById(R.id.game);
    ...
    public void InsertDataIntoSQLiteDatabase(){
        ...
        if(EditTextEmptyHolder == true)
        {
            ...
            SQLiteDataBaseQueryHolder = "INSERT INTO " + SQLiteHelper.TABLE_NAME + " (name,email,password,Contact,Qualification,Gender,pre_history,games,P_session,title) VALUES('" + editName.getText().toString() + "', '" + editemail.getText().toString() + "', '" + editpassword.getText().toString() + "', '" + editcontact.getText().toString() + "', '" + qualification.getSelectedItem().toString() + "', '" + gender.getSelectedItem().toString() + "', '" + editpre.getText().toString() + "', '" + games.getSelectedItem().toString() + "' , '" + editprac.getText().toString() + "', '" + edittitle.getText().toString() + "');";
            // Executing query.
    ...
    public void CheckEditTextStatus(){
       ...
       String g= games.getSelectedItem().toString();


        if(TextUtils.isEmpty(NameHolder) || TextUtils.isEmpty(EmailHolder) || TextUtils.isEmpty(PasswordHolder)||TextUtils.isEmpty(g)){
    ...
    {
        if (EditTextEmptyHolder == true) {
            String  str1 =editemail.getText().toString();
            String str2 = games.getSelectedItem().toString();
